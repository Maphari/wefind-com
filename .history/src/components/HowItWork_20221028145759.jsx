          ...
          <div className="how-it-works-cards">
            ...
            <div className="how-it-works-cards__information">
              <h1 className="how-it-works-cards__information-title">
                Search for help, and you can<br/> browse availbale categories.
              </h1>
              <div className="how-it-works-cards__information-btn">
                <button className="btn-btn-func">Learn more</button>
                <button className="btn-btn-func">Get started</button>
              </div>
            </div>
          </div>
        </div>
