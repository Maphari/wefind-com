      ...
      <div className="how-it-works-container">
        <div className="how-containerr">
          ...
          <div className="info">
            <div className="how-it-works-cards">
              ...
              <div className="how-it-works-cards__information">
                <h1 className="how-it-works-cards__information-title">
                  ...
                  <br /> browse available categories.<br/> No need to worry . 
                </h1>
            ...
            <div className="how-it-works-cards">
              ...
              <div className="how-it-works-cards__information">
                <h1 className="how-it-works-cards__information-title">
                  ...
                  <br /> of messaging so that you<br/> communicate with your helper.
                </h1>
                <div className="how-it-works-cards__information-btn">
                  <button className="btn-btn-1">Learn more</button>
                  <button className="btn-btn-2">Get started</button>
            ...
            <div className="how-it-works-cards">
              <div className="how-it-works-cards__images">
                <img src={img2} alt="showcase img-3" />
              </div>
              <div className="how-it-works-cards__information">
                <h1 className="how-it-works-cards__information-title">
                  You can see your helpers <br/>history
                  <br /> and past jobs the the <br/>helpers has done
                </h1>
                <div className="how-it-works-cards__information-btn">
                  <button className="btn-btn-1">Learn more</button>
                  <button className="btn-btn-2">Get started</button>
            ...
            <div className="how-it-works-cards">
              <div className="how-it-works-cards__images">
                <img src={img3} alt="showcase img-3" />
              </div>
              <div className="how-it-works-cards__information">
                <h1 className="how-it-works-cards__information-title">
                  Keep track of your profile
                  <br /> and recent assist that you<br/> got.
                </h1>
                <div className="how-it-works-cards__information-btn">
                  <button className="btn-btn-1">Learn more</button>
                  <button className="btn-btn-2">Get started</button>
