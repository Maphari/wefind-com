      ...
      <div className="showcase-container">
        <div className="container">
          <div className="showcase-container__section">
            ...
            <button className="mobile hover:bg-slate-700 bg-slate-900 px-5 py-3 mr-3">Google Play</button>
            <button className="mobile hover:bg-slate-700 bg-slate-900 px-5 py-3">Apple Store</button>
          </div>
