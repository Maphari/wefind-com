      ...
      <div className="showcase-container">
        <div className="container">
          <div className="showcase-container__section">
            ...
            <button className="btn drop-shadow-md">Get started</button>

            <p className="get-mobile">Get our mobile application</p>
            <button className="mobile drop-shadow-lg hover:bg-slate-700 bg-slate-900 px-5 py-3 mr-3">Google Play</button>
            <button className="mobile drop-shadow-lg hover:bg-slate-700 bg-slate-900 px-5 py-3">Apple Store</button>
          </div>
