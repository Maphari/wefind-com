        ...
        <div className="container-serv">
          ...
          <div className="containerr">
            ...
            <CardsService
              ...
              message="WeFind gives you choice to be a helper if you are qualify to be so you can make extra cash for yourself."
            />
            <CardsService
              number="06"
              title="Search for help"
              message="Search for help, and you can browse available categories.No need to worry."
            />
            <CardsService
              number="07"
              title="Wefind gives choice"
              message="WeFind gives you the fexibility of messaging so that you communicate with your helper."
            />
            <CardsService
              number="08"
              title="Wefind gives choice"
