    ...
    <Fragment>
      <div className="showcase-container">
        <div className="showcase-container__section">
          ...
          <p className="showcase-container__para">We are here to help you don't hesitate.</p>
          <button>Get star</button>
        </div>

        <div className="showcase-container__images">images</div>
      </div>
    </Fragment>
  );
}
