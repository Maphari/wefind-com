      ...
      <div className="container-footer">
        <div className="container-footer__f">
          ...
          <div className="mobile-apps">
            ...
            <button className="btn-app-1 bg-teal-800 py-2 px-5 rounded-md mt-3 mr-2">
              <i className="fa-brands fa-google-play"></i> Google Play
            </button>
            <button className="btn-app-2 bg-teal-800 py-2 px-5 rounded-md mt-3">
          ...
          <div className="socials">
            ...
            <div className="socials__container"></div>
