        ...
        <div className="container">
          <div className="showcase-container__section">
            <h1 className="showcase-container__header">
              ...
              <span className="before:block before:absolute before:-inset-1 before:-skew-y-1 before:bg-[#0eb05a] relative inline-block">
          ...
          <div className="showcase-container__images">
            <img src={show} alt="showcase-img" className="big-image" />
            <img src={phone} alt="phone showcase" className="small-image" />
          </div>
        </div>
      </div>
    </Fragment>
